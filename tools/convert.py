#!/usr/bin/env python3
"""Convert HuggingFace model to knivesysl GGUF format.
...
class GGUFWriter:
    """Minimal GGUF file writer for knivesysl weight format."""
...
def convert_model(model_path, output_path, quant):
    ...
    writer.add_metadata('knivesysl.quantization', quant)
...
def main():
    parser = argparse.ArgumentParser(
        description='Convert HuggingFace model to knivesysl GGUF format')
