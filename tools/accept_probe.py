...
Port of tl-e tools/e2e_honest.py to the knivesysl qwn_* ABI. Use for the
...
L = load_lib(os.environ.get("TQ_LIB", "/workspace/knivesysl/build-qwen/libforward_qwen.so"))
